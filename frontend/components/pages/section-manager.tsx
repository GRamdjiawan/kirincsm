...
type CarouselContent = BaseContent & {
  slides: Array<{
    id: string
    imageUrl: string
    caption: string
...
type GalleryContent = BaseContent & {
  images: Array<{
    id: string
    imageUrl: string
    caption: string
...
type CardSectionContent = BaseContent & {
  imageUrl: string
  heading: string
  text: string
  buttonText: string
...
type SectionContent = TextContent | CarouselContent | GalleryContent | CardSectionContent | HeroContent
...
const createDefaultContent = (type: SectionType): SectionContent => {
  switch (type) {
    case "TEXT":
      return {
        title: "Text Section",
